...
<body>
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="d-flex flex-column sidebar flex-shrink-0 p-3 bg-light" style="width: 280px; height: 700px">
                        <ul class="nav nav-pills flex-column mb-auto">
                           ...
                           <li><a href="gettestdetails" class="nav-link " >Tests</a></li>
							<li><a href="booktest" class="nav-link link-dark">Book Test</a></li>
                ...
                <div class="col-md-9">
                    ...
                    <h1>Details for Test Booking</h1></center>
            <div class="form-group">
	...
	<form action="generateBill" method="post">
		<!-- Add your test selection options here -->
		<input type="checkbox" name="test" value="test1"> Test 1<br>
		<input type="checkbox" name="test" value="test2"> Test 2<br>
		<input type="checkbox" name="test" value="test3"> Test 3<br>
		<!-- Add more test options if needed -->
