...
<div class="container">
    ...
    <form id="profileUpdateForm" enctype="multipart/form-data">
        <div class="form-group">
            ...
            <input type="tel" id="patientIdInput" required>
        </div>
        <div class="form-group">
            <label for="appointmentIdInput">Appointment ID:</label>
            <input type="tel" id="appointmentIdInput" required>
        </div>
        <div class="form-group">
            <label for="parameterInput">Parameter:</label>
            <input type="text" id="parameterInput" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <textarea id="medicalHistoryTextarea" rows="4"></textarea>
        </div>
        <div class="form-group">
            <label for="prescriptionsTextarea">Prescriptions:</label>
            <textarea id="prescriptionsTextarea" rows="4"></textarea>
        </div>
        <div class="form-group">
            <label for="referralsTextarea">Future Updates:</label>
            <textarea id="referralsTextarea" rows="4"></textarea>
        </div>
        <div class="form-group">
            <label for="reportsInput">Upload Reports:</label>
            <input type="file" id="reportsInput" multiple>
        </div>
        <div class="form-group">
