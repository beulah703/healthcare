...
public class diagnosticBillModel {
	...
	public diagnosticBillModel(int dgbl_amount, String dgbl_date, int dgbl_patn_id, String dgbl_patn_type, int dgbl_id) {
	...
	public diagnosticBillModel(int dgbl_patn_id, String dgbl_date, int dgbl_amount, String dgbl_patn_type) {
